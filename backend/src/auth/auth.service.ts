...
export class AuthService implements OnModuleInit, OnModuleDestroy {
  ...
  /** Busca el usuario local (con su rol) por id. Usado por RolesGuard. */
  public async getLocalUserById(id: string): Promise<User | null> {
  ...
  public async login(email: string, password: string) {
    ...
    if (error) {
      throw new UnauthorizedException(
        `Credenciales incorrectas o usuario no verificado. Error: ${error.message}`,
      );
    }
