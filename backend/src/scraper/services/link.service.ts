...
export class LinkService {
    ...
    public async update(id: string, link: QueryDeepPartialEntity<Link>) : Promise<Link | null> {
    ...
    public async updateByURL(url: string, link: QueryDeepPartialEntity<Link>) : Promise<Link | null> {
